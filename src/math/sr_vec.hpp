...
inline vec2 normalize(vec2 a) { float l = length(a); return l ? a / l : a; }
...
inline vec3 normalize(vec3 a) { float l = length(a); return l ? a / l : a; }
...
inline vec4 normalize(vec4 a) { float l = length(a); return l ? a / l : a; }
