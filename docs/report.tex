...
\paragraph{Contribuciones por autor.} 
\begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\setlength{\topsep}{2pt}
  \item Kalos Lazo: Integración con embree y \emph{benchmark}.
  \item Lenin Chávez: escena, sombreado y renderer multihilo.
  \item Marcelo Chincha: backend OpenCL/GPU, BVH y heurísticas de construcción .
\end{itemize}
