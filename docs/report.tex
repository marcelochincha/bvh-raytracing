...
\begin{figure}[h]\centering
\includegraphics[width=0.50\textwidth]{fig_dynamic.png}
...
\paragraph{Enlaces.} Repositorio: \url{https://github.com/USUARIO/bvh-raytracing}
\quad$\bullet$\quad Video demo: \url{ENLACE} \quad$\bullet$\quad Presentación:
\url{ENLACE}. Datos y figuras: \texttt{docs/benchmark.csv},
